...
main(int argc, char **argv)
{
    ...
    pcl::io::loadPCDFile ("/home/janak/relocalization/src/relocalization/data/area.pcd", ScanCloud);
    pcl::io::loadPCDFile ("/home/janak/relocalization/src/relocalization/data/kitti2.pcd", MapCloud);
