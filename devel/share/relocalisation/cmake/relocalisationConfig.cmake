...
if(relocalisation_CONFIG_INCLUDED)
  return()
endif()
set(relocalisation_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(relocalisation_SOURCE_PREFIX /home/janak/relocalization/src/relocalization)
  set(relocalisation_DEVEL_PREFIX /home/janak/relocalization/devel)
  set(relocalisation_INSTALL_PREFIX "")
  set(relocalisation_PREFIX ${relocalisation_DEVEL_PREFIX})
else()
  set(relocalisation_SOURCE_PREFIX "")
  set(relocalisation_DEVEL_PREFIX "")
  set(relocalisation_INSTALL_PREFIX /home/janak/relocalization/install)
  set(relocalisation_PREFIX ${relocalisation_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'relocalisation' is deprecated")
...
set(relocalisation_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/janak/relocalization/src/relocalization/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(relocalisation_INCLUDE_DIRS "")
  set(_include_dirs "/home/janak/relocalization/src/relocalization/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'luis <jane.doe@example.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${relocalisation_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'relocalisation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'relocalisation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/janak/relocalization/src/relocalization/${idir}'.  ${_report}")
    endif()
    _list_append_unique(relocalisation_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND relocalisation_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND relocalisation_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT relocalisation_NUM_DUMMY_TARGETS)
      set(relocalisation_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::relocalisation::wrapped-linker-option${relocalisation_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR relocalisation_NUM_DUMMY_TARGETS "${relocalisation_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::relocalisation::wrapped-linker-option${relocalisation_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND relocalisation_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/janak/relocalization/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(relocalisation_LIBRARY_DIRS ${lib_path})
      list(APPEND relocalisation_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'relocalisation'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND relocalisation_LIBRARIES ${lib})
    endif()
  endif()
...
set(relocalisation_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${relocalisation_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 relocalisation_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${relocalisation_dep}_FOUND)
      find_package(${relocalisation_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${relocalisation_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(relocalisation_INCLUDE_DIRS ${${relocalisation_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(relocalisation_LIBRARIES ${relocalisation_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${relocalisation_dep}_LIBRARIES})
  _list_append_deduplicate(relocalisation_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(relocalisation_LIBRARIES ${relocalisation_LIBRARIES})

  _list_append_unique(relocalisation_LIBRARY_DIRS ${${relocalisation_dep}_LIBRARY_DIRS})
  list(APPEND relocalisation_EXPORTED_TARGETS ${${relocalisation_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${relocalisation_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
